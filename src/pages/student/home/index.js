    ...
    <div>
      <div>
        <div
          ...
          className="top-[8.1%] md:top-[12.2%] h-12 w-12"
      ...
      <div className="mx-[12px] md:mx-[100px] text-center">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} lg={6}>
            <div class="text-left">
              Đọc sách là điều cần thiết để học ngoại ngữ Đặc biệt, trẻ càng nhỏ
              thì càng tiếp thu nhanh ngoại ngữ Dù không thạo toàn bộ, bạn vẫn
              có thể phát triển kĩ năng Đọc Hiểu bằng suy đoán nội dung qua hình
              ảnh Đọc, giúp bạn học thêm nhiều cách diễn đạt và cấu trúc câu hơn
              là đàm thoại đơn giản, là một trong những cách tốt nhất để học Anh
              văn.<br></br> (Moeller & Meyer, 1995)
            </div>
          </Grid>
      ...
      <div className="bg-[url('https://readingtime.today/resources/img/main/sec3_bg.png')] bg-cover bg-center">
        <div className="py-20 px-[12px] md:px-[100px]">
          ...
          <p className="text-[20px]">
            25 phút mỗi ngày, với sự hướng dẫn của giáo viên nước ngoài, bạn sẽ
            tạo được thói quen đọc tiếng Anh
            <br></br>
